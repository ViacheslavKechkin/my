...
Ищет переменную если не находит идет в скойп выше и ищет ее там
...
и дополнительные значения. (arr.contact() - можно так копировать массив ! ! !)
потому что без параметров cancat возвращает копию массива
